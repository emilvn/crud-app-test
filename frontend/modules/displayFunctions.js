...
function showCharacter(character) {
    ...
    document.querySelector("#characters article:last-child div button:first-child").addEventListener("click", () => { event.stopPropagation(); deleteCharacter(character._id) });
